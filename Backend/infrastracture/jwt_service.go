...
func (tg *TokenGeneratorImpl) GenerateToken(user domain.BaseUser) (string, error) {
...
func (tg *TokenGeneratorImpl) GenerateRefreshToken(user domain.BaseUser) (string, error) {
